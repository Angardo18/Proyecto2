...
INT_ADC:
    ...
    BTFSS   ADCON0,2 ;SI ESTE BIT ES CERO SE ESTABA LEYENDO EL CANAL 1
    GOTO LECTURA_C1
    
    MOVWF ADC_C1
    BCF	ADCON0,2 ;SE CAMBIA AL CANAL 0
    GOTO    FINAL
    
    LECTURA_C1
    MOVWF   ADC_C0
    BSF	ADCON0,2 ;SE CAMBIA AL CANAL 1
